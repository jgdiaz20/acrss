...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('room_create')): ?>
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route("admin.room-management.rooms.create")); ?>">
...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            <span class="badge badge-primary mr-2">Total: <?php echo e($rooms->count()); ?> rooms</span>
    ...
    <div class="card-body">
        ...
        <div class="filters-section mb-3">
            ...
            <div class="row d-none d-md-flex">
                <div class="col-md-2">
                    <select class="form-control form-control-sm" id="type-filter">
                        ...
                        <option value="lab" <?php echo e(request('type') == 'lab' ? 'selected' : ''); ?>>Laboratory</option>
                        <option value="classroom" <?php echo e(request('type') == 'classroom' ? 'selected' : ''); ?>>Classroom</option>
                    </select>
                </div>
                <div class="col-md-2">
                    <select class="form-control form-control-sm" id="equipment-filter">
                        <option value="">Equipment</option>
                        <option value="1" <?php echo e(request('equipment') == '1' ? 'selected' : ''); ?>>Available</option>
                        <option value="0" <?php echo e(request('equipment') == '0' ? 'selected' : ''); ?>>Not Available</option>
                    </select>
                </div>
                <div class="col-md-1">
                    <input type="number" class="form-control form-control-sm" id="capacity-min" placeholder="Min" value="<?php echo e(request('capacity_min')); ?>">
                </div>
                <div class="col-md-1">
                    <input type="number" class="form-control form-control-sm" id="capacity-max" placeholder="Max" value="<?php echo e(request('capacity_max')); ?>">
                </div>
                <div class="col-md-2">
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control" id="search-input" placeholder="Search rooms..." value="<?php echo e(request('search')); ?>">
                ...
                <div class="col-md-1">
                    <a href="<?php echo e(route('admin.room-management.rooms.index')); ?>" class="btn btn-secondary btn-sm btn-block">
            ...
            <div class="d-md-none">
                ...
                <div class="mb-2">
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control" id="search-input-mobile" placeholder="Search rooms..." value="<?php echo e(request('search')); ?>">
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="button" onclick="applyFilters()">
                                <i class="fas fa-search"></i>
                            </button>
                    ...
                    <div class="card card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" id="equipment-filter-mobile">
                                ...
                                <option value="1" <?php echo e(request('equipment') == '1' ? 'selected' : ''); ?>>Equipment Available</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="number" class="form-control form-control-sm" id="capacity-min-mobile" placeholder="Min" value="<?php echo e(request('capacity_min')); ?>">
                                </div>
                                <div class="col-6">
                                    <input type="number" class="form-control form-control-sm" id="capacity-max-mobile" placeholder="Max" value="<?php echo e(request('capacity_max')); ?>">
                                </div>
                            </div>
                        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-md-6 text-right">
                <span class="text-muted">
                    Showing <?php echo e($rooms->firstItem() ?? 0); ?> to <?php echo e($rooms->lastItem() ?? 0); ?> of <?php echo e($rooms->total()); ?> rooms
                </span>
            </div>
        </div>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Room">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr data-entry-id="<?php echo e($room->id); ?>" data-room-id="<?php echo e($room->id); ?>">
                            <td>
                            ...
                            <td>
                                <a href="<?php echo e(route('admin.room-management.room-timetables.show', $room->id)); ?>" class="btn btn-sm btn-info">
                                    View Timetable
                                </a>
                            </td>
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('room_show')): ?>
                                    <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.room-management.rooms.show', $room->id)); ?>">
                                        View
                                    </a>
                                <?php endif; ?>

                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('room_edit')): ?>
                                    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.room-management.rooms.edit', $room->id)); ?>">
                                        Edit
                                    </a>
                                <?php endif; ?>

                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('room_show')): ?>
                                    <button onclick="showQRCode(<?php echo e($room->id); ?>, '<?php echo e($room->name); ?>')" class="btn btn-xs btn-outline-success" title="View QR Code">
                                        <i class="fas fa-qrcode"></i>
                                    </button>
                                <?php endif; ?>

                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('room_delete')): ?>
                                    <form action="<?php echo e(route('admin.room-management.rooms.destroy', $room->id)); ?>" method="POST" onsubmit="return confirm('Are you sure?');" style="display: inline-block;">
                        ...
                        <tr>
                            <td colspan="9" class="text-center py-5">
                                <div class="empty-state">
                                    ...
                                    <p class="text-muted">
                                        <?php if(request()->hasAny(['type', 'equipment', 'capacity_min', 'capacity_max', 'search'])): ?>
                                    ...
                                    <?php if(request()->hasAny(['type', 'equipment', 'capacity_min', 'capacity_max', 'search'])): ?>
                                        <a href="<?php echo e(route('admin.room-management.rooms.index')); ?>" class="btn btn-primary mt-2">
                                             Clear All Filters
                                        </a>
                                    <?php endif; ?>
                                </div>
        ...
        <?php if($rooms->hasPages()): ?>
            <div class="d-flex justify-content-center mt-3">
                <?php echo e($rooms->appends(request()->query())->onEachSide(1)->links('pagination::bootstrap-4')); ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('room_delete')): ?>
  ...
  let deleteButton = {
    ...
    url: "<?php echo e(route('admin.room-management.rooms.massDestroy')); ?>",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jimbo\Desktop\Laravel_Timetable\Laravel-School-Timetable-Calendar\resources\views/admin/rooms/index.blade.php ENDPATH**/ ?>
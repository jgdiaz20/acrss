    ...
    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number" id="totalRooms"><?php echo e($totalRooms); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number" id="totalLessons"><?php echo e($totalLessons); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number" id="activeTeachers"><?php echo e($activeTeachers); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number" id="totalConflicts"><?php echo e($totalConflicts); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <a href="<?php echo e(route('admin.room-management.master-timetable.show', 1)); ?>" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jimbo\Desktop\Laravel_Timetable\Laravel-School-Timetable-Calendar\resources\views/admin/room-management/master-timetable/index.blade.php ENDPATH**/ ?>
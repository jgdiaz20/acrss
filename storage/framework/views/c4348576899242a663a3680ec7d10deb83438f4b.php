        ...
        <div class="modal-content validation-modal">
            ...
            <div class="modal-body">
                ...
                <div class="text-right mt-3 pt-3 border-top">
                    <a href="<?php echo e(route('admin.room-management.master-timetable.show', request('weekday', 1))); ?>" class="btn btn-outline-primary btn-md" target="_blank">
...
</style><?php /**PATH C:\Users\jimbo\Desktop\Laravel_Timetable\Laravel-School-Timetable-Calendar\resources\views/components/validation-modal.blade.php ENDPATH**/ ?>
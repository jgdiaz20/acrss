    ...
    <div class="card-body">
        ...
        <form method="POST" action="<?php echo e(route("admin.lessons.store")); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control <?php echo e($errors->has('lesson_type') ? 'is-invalid' : ''); ?>" name="lesson_type" id="lesson_type" required>
                    ...
                    <?php $__currentLoopData = \App\Lesson::LESSON_TYPES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>" <?php echo e(old('lesson_type') == $key ? 'selected' : ''); ?>><?php echo e($type); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control <?php echo e($errors->has('weekday') ? 'is-invalid' : ''); ?>" name="weekday" id="weekday" required>
                    ...
                    <?php $__currentLoopData = \App\Lesson::WEEK_DAYS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>" <?php echo e((string) old('weekday', request('weekday')) === (string) $key ? 'selected' : ''); ?>><?php echo e($day); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control lesson-timepicker <?php echo e($errors->has('end_time') || $errors->has('duration_hours') ? 'is-invalid' : ''); ?>" type="text" name="end_time" id="end_time" value="<?php echo e(old('end_time', request('end_time'))); ?>" required>
...
<script>
    ...
    window.subjectsLookup = {
        <?php $__currentLoopData = $subjectsCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo e($subject->id); ?>: {
                id: <?php echo e($subject->id); ?>,
                scheduling_mode: '<?php echo e($subject->scheduling_mode ?? ''); ?>'
            },
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    };
...
$(document).ready(function() {
    ...
    $(document).ready(function() {
        ...
        const oldTeacherId = '<?php echo e(old("teacher_id")); ?>';

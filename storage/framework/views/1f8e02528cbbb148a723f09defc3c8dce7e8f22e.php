    ...
    <div class="card-body">
        ...
        <?php if($subject->lessons()->count() > 0): ?>
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                ...
                <strong>Warning:</strong> This subject has <strong><?php echo e($subject->lessons()->count()); ?> existing lesson(s)</strong>. 
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo e($errors->has('credits') ? 'is-invalid' : ''); ?>" type="number" name="credits" id="credits" value="<?php echo e(old('credits', $subject->credits)); ?>" min="1" max="3" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control <?php echo e($errors->has('scheduling_mode') ? 'is-invalid' : ''); ?>" name="scheduling_mode" id="scheduling_mode" required>
                            ...
                            <?php $__currentLoopData = \App\Subject::SCHEDULING_MODES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $mode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(old('scheduling_mode', $subject->scheduling_mode) == $key ? 'selected' : ''); ?>><?php echo e($mode); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo e($errors->has('lecture_units') ? 'is-invalid' : ''); ?>" type="number" name="lecture_units" id="lecture_units" value="<?php echo e(old('lecture_units', $subject->lecture_units)); ?>" min="0" max="10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo e($errors->has('lab_units') ? 'is-invalid' : ''); ?>" type="number" name="lab_units" id="lab_units" value="<?php echo e(old('lab_units', $subject->lab_units)); ?>" min="0" max="10">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Current Lessons:</strong> This subject has <strong><?php echo e($subject->lessons()->count()); ?> existing lesson(s)</strong>.
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const hasLessons = <?php echo e($subject->lessons()->count() > 0 ? 'true' : 'false'); ?>;

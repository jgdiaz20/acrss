                ...
                <div class="timetable-wrapper">
                    <div class="timetable-grid" id="roomTimetableGrid">
                        ...
                        <?php $__currentLoopData = $weekDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayNumber => $dayName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="timetable-day-header <?php echo e(($dayNumber == 6 || $dayNumber == 7) ? 'weekend' : ''); ?>">
                        ...
                        <?php $__currentLoopData = $timetableData['timetable_matrix']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowIndex => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <!-- Day Cells -->
                            <?php $__currentLoopData = $row['days']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayIndex => $dayData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                ?>
                                <div class="timetable-cell <?php echo e($rowIndex % 2 === 0 ? 'zebra-row' : ''); ?> <?php echo e($isLesson ? 'lesson-cell ' . $lessonClass . ' ' . $dayData['css_class'] : $dayData['css_class']); ?> <?php echo e(($dayNumber == 6 || $dayNumber == 7) ? 'weekend' : ''); ?>" 
                                     data-room-id="<?php echo e($room->id); ?>"
                                     data-weekday="<?php echo e($dayNumber); ?>"
                                     data-time-start="<?php echo e($row['time_slot']['start']); ?>"
                                     data-time-end="<?php echo e($row['time_slot']['end']); ?>"
                                     data-time-start-formatted="<?php echo e($row['time_slot']['start_formatted']); ?>"
                                     data-time-end-formatted="<?php echo e($row['time_slot']['end_formatted']); ?>"
                                     <?php if(!$isLesson): ?> title="Enable edit mode to schedule lesson" <?php endif; ?>>
                                    <?php if($isLesson): ?>
                                        <?php if($isStartSlot): ?>
                                            <div class="class-box lesson-slot editable-lesson <?php echo e(str_replace(['has-conflicts','long-lesson','short-lesson'], '', $dayData['css_class'])); ?>" 
                                                 data-lesson-id="<?php echo e($lesson->id); ?>"
                                                 title="Subject: <?php echo e($lesson->subject->name ?? 'No Subject'); ?> (<?php echo e($lesson->subject->code ?? 'N/A'); ?>) | Type: <?php echo e(ucfirst($lesson->lesson_type)); ?> | Class: <?php echo e($lesson->class->display_name ?? 'No Class'); ?> | Teacher: <?php echo e($lesson->teacher->name ?? 'No Teacher'); ?> | Time: <?php echo e($lesson->start_time); ?> - <?php echo e($lesson->end_time); ?>">
                                                <div class="class-subject">
                                                    <?php echo e($lesson->subject->code ?? 'No Code'); ?>

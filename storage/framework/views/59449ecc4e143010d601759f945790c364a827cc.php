...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route("admin.room-management.rooms.update", [$room->id])); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jimbo\Desktop\Laravel_Timetable\Laravel-School-Timetable-Calendar\resources\views/admin/rooms/edit.blade.php ENDPATH**/ ?>
                        ...
                        @else
                            ...
                            <select class="form-control {{ $errors->has('program_id') ? 'is-invalid' : '' }}" name="program_id" id="program_id" required>
                                ...
                                @foreach($academicPrograms as $program)
                                    <option value="{{ $program->id }}" {{ (old('program_id', $schoolClass->program_id) == $program->id) ? 'selected' : '' }}>
                                        {{ $program->name }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('section') ? 'is-invalid' : '' }}" type="text" name="section" id="section" value="{{ old('section', $schoolClass->section) }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('max_students') ? 'is-invalid' : '' }}" type="number" name="max_students" id="max_students" value="{{ old('max_students', $schoolClass->max_students) }}" min="1">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('is_active') ? 'is-invalid' : '' }}" name="is_active" id="is_active">
                            <option value="1" {{ (old('is_active', $schoolClass->is_active) == '1') ? 'selected' : '' }}>Active</option>
                            <option value="0" {{ (old('is_active', $schoolClass->is_active) == '0') ? 'selected' : '' }}>Inactive</option>
                        </select>
